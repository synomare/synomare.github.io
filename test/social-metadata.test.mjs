...
test('トップページはSNS共有用の画像と絶対URLを公開する', async () => {
  ...
  const imagePath = path.join(repoRoot, 'assets', 'images', 'og-default.jpg');
  ...
  assert.match(source, /<meta property="og:image" content="https:\/\/synomare\.github\.io\/assets\/images\/og-default\.jpg">/);
  ...
  assert.match(source, /<meta name="twitter:image" content="https:\/\/synomare\.github\.io\/assets\/images\/og-default\.jpg">/);
